...
if __name__ == "__main__":
    path = "/Users/chaoxu/code/local-spark/Data/qiancheng"
    save_path = "/Users/chaoxu/code/local-spark/Data"
    spark = SparkSession.builder.appName("qiancheng").getOrCreate()
    ...
    print cols
    df = df[cols]
    df.to_csv(save_path + '/qiancheng.csv', encoding='utf-8')
