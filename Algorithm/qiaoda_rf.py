...
from Params.rf_params import rf_base_params, rf_qiaoda_params
...
def qiaoda_rf(df,postfix='part1'):
    ...
    _params, _ = gridCV(clf=RandomForestClassifier, X=X_train, y=y_train_cv,
                        base_params=rf_base_params, all_test_params=rf_qiaoda_params,
                        cv_parmas=cv_params,model_path=params_path)
    clf = RandomForestClassifier(**_params)
